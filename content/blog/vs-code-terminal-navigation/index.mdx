...
![VS Code editor with an integrated terminal opened in the bottom panel](./assets/integrated-terminal.png)
...
![VS Code editor with two integrated terminals (split terminals) opened in the bottom panel](./assets/split-terminal.png)
